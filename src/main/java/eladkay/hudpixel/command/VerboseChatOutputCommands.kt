...
object VerboseChatOutputCommand : HpCommandBase() {
    ...
    override fun processCommand(sender: ICommandSender, args: Array<out String>?) {
        if (enabled) {
            enabled = false
            sender.addChatMessage(ChatComponentText("${EnumChatFormatting.RED}Disabled verbose chatgui output!"))
        } else {
            enabled = true
            sender.addChatMessage(ChatComponentText("${EnumChatFormatting.GREEN}Enabled verbose chatgui output!"))
        }
    }
...
object ClickEventCommand : HpCommandBase() {
    ...
    override fun processCommand(sender: ICommandSender, args: Array<out String>?) {
        if (enabled) {
            enabled = false
            sender.addChatMessage(ChatComponentText("${EnumChatFormatting.RED}Disabled click event chatgui output!"))
        } else {
            enabled = true
            sender.addChatMessage(ChatComponentText("${EnumChatFormatting.GREEN}Enabled click event chatgui output!"))
        }
    }
