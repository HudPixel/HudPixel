...
object PlayerDatabase {
    ...
    fun getPlayerByID(name: String): Player? {
    ...
    fun add(player: Player, iPlayerLoadedCallback: IPlayerLoadedCallback?) {
        players.put(player.uuid, player)
        iPlayerLoadedCallback?.onPlayerLoadedCallback(player.uuid)
    }
}
