 ...
 **********************************************************************************************************************/
class TNTStatsViewer(uuid: UUID, statsName: String) : AbstractStatsViewer(uuid, statsName), McColorHelperJava {
    ...
    private fun generateRenderList() {
        getRenderList()?.add(COINS + McColorHelperJava.GOLD + this.coins + WINS + McColorHelperJava.GOLD + this.wins)
    ...
    public override fun composeStats() {
