 ...
 **********************************************************************************************************************/
class ArenaStatsViewer(uuid: UUID, statsName: String) : AbstractStatsViewer(uuid, statsName), McColorHelper {
    ...
    */
        private val COINS = DARK_GRAY + " [" + GRAY + "Coins" + DARK_GRAY + "] "
        private val WINS = DARK_GRAY + " [" + GRAY + "Wins" + DARK_GRAY + "] "
        private val KILLS = DARK_GRAY + " [" + GRAY + "Kills" + DARK_GRAY + "] "
        private val DEATHS = DARK_GRAY + " [" + GRAY + "Deaths" + DARK_GRAY + "] "
        private val KD = DARK_GRAY + " [" + GRAY + "K/D" + DARK_GRAY + "] "
    }
}