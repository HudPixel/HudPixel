...
object PlayGameModularGuiProvider : HudPixelModularGuiProvider() {
    ...
    override fun content(): String {
        if (content == "solo_insane" || content == "solo_normal" || content == "team_insane" || content == "team_normal")
            return ChatFormatting.AQUA + "Press P to play " + ChatFormatting.BLUE + "SkyWars"
        if (content == "blitz_solo_insane")
            return ChatFormatting.AQUA + "Press P to play " + ChatFormatting.BLUE + "BSG"
        return content
    }
