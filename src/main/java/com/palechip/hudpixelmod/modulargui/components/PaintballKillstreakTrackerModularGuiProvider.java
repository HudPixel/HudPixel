...
public class PaintballKillstreakTrackerModularGuiProvider extends SimpleHudPixelModularGuiProvider {
    ...
    private static final String COOLDOWN_SIGN = ChatFormatting.RED + "\u2717"; // fancy x
    private static final String ACTIVE_SIGN = ChatFormatting.GREEN + "\u2713"; // isHypixelNetwork mark
    ...
    private String getColorForTime(long time) {
        if (time >= 10) {
            ...
            // RED and bold
            return String.valueOf(ChatFormatting.RED + "" + ChatFormatting.BOLD);
        }
    }
